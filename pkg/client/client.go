...
// http://{baseurl}/rest/api/latest/users
// http://{baseurl}/rest/api/latest/projects
// http://{baseurl}/rest/api/latest/admin/groups
const (
	allUsersEndpoint = "rest/api/latest/users"
	allProjects      = "rest/api/latest/projects"
	allRepositories  = "rest/api/latest/repos"
	allGroups        = "rest/api/latest/groups"
)
...
func New(ctx context.Context, baseUrl string, bitbucketClient *DataCenterClient) (*DataCenterClient, error) {
	...
	// baseUrl, err = url.JoinPath(baseUrl, "rest/api/latest")
	// if err != nil {
	// 	return nil, err
	// }
...
func (d *DataCenterClient) GetProjects(ctx context.Context, startPage, limit string) ([]Projects, Page, error) {
	...
	endpointUrl, err := url.JoinPath(d.baseUrl, allProjects)
	if err != nil {
		return nil, Page{}, err
	}
...
func (d *DataCenterClient) GetRepos(ctx context.Context, startPage, limit string) ([]Repos, Page, error) {
	...
	endpointUrl, err := url.JoinPath(d.baseUrl, allRepositories)
	if err != nil {
		return nil, Page{}, err
	}
...
func (d *DataCenterClient) GetGroups(ctx context.Context, startPage, limit string) ([]string, Page, error) {
	...
	endpointUrl, err := url.JoinPath(d.baseUrl, allGroups)
	if err != nil {
		return nil, Page{}, err
	}
...
func (d *DataCenterClient) GetGroupMembers(ctx context.Context, startPage, limit, groupName string) ([]Members, Page, error) {
	...
	strUrl := fmt.Sprintf("%s/admin/groups/more-members?context=%s", d.baseUrl, groupName)
...
func (d *DataCenterClient) GetGlobalUserPermissions(ctx context.Context, startPage, limit string) ([]UsersPermissions, Page, error) {
	...
	strUrl, err := url.JoinPath(d.baseUrl, "admin/permissions/users")
	if err != nil {
		return nil, Page{}, err
	}
...
func (d *DataCenterClient) GetGlobalGroupPermissions(ctx context.Context, startPage, limit string) ([]GroupsPermissions, Page, error) {
	...
	strUrl, err := url.JoinPath(d.baseUrl, "admin/permissions/groups")
	if err != nil {
		return nil, Page{}, err
	}
